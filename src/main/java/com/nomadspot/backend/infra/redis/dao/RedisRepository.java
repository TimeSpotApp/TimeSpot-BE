...
public interface RedisRepository {
    ...
    TypedTuple<Object> popMinFromZSet(String key);

    Set<TypedTuple<Object>> popMinFromZSet(String key, long count);

    TypedTuple<Object> popMaxFromZSet(String key);

    Set<TypedTuple<Object>> popMaxFromZSet(String key, long count);
