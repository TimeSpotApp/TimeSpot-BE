    ...
    throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Role Admin Only
                        .requestMatchers(HttpMethod.GET, SecurityConst.GET_ROLE_ADMIN_URLS)
                        .hasAuthority(UserRole.ADMIN.getAuthority())
                        .requestMatchers(HttpMethod.POST, SecurityConst.POST_ROLE_ADMIN_URLS)
                        .hasAuthority(UserRole.ADMIN.getAuthority())
                        .requestMatchers(HttpMethod.PUT, SecurityConst.PUT_ROLE_ADMIN_URLS)
                        .hasAuthority(UserRole.ADMIN.getAuthority())
                        .requestMatchers(HttpMethod.PATCH, SecurityConst.PATCH_ROLE_ADMIN_URLS)
                        .hasAuthority(UserRole.ADMIN.getAuthority())
